...
<!-- Please read the https://github.com/linuxserver/docker-wireguard/blob/alpine/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/wireguard:alpine` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/wireguard:alpine`
...
* Update the image: `docker pull lscr.io/linuxserver/wireguard:alpine`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/wireguard:alpine .
```
